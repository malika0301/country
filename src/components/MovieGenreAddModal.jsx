...
const MovieGenreAddModal = ({ genre, movie, getMovieGenre }) => {
    ...
    const onFinish = async (values) => {
        try {
            await axios.post(`https://x8ki-letl-twmt.n7.xano.io/api:j6hO02gL/movie_genre`,
                values,);
                    ...
                    <div style={{ display: "grid", gap: "10px" }}>
                        ...
                        <div style={{ display: "grid" }}>
                            <Form.Item
                                name="genre_id"
                                layout='vertical'
                                label="Genre" rules={[{ required: true }]}>
                                <Select
                                    allowClear
