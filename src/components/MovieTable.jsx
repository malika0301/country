...
const MovieTable = ({ data }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'name',
            render: text => <Image style={{ objectFit: "cover" }}
                alt="basic image"
                width={60}
                height={60}
                src={text}
...

        {
            ...
            key: 'name',
            render: text => <p style={{ display: "flex", gap: "3px", alignItems: "center" }}>{text}<CiStar /></p>,
        },
        {
            title: 'Country',
            dataIndex: 'country',
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    <Button danger onClick={() => deleteMovie(record.id)}>Delete</Button>
                </Space>
            ),
        },
    ];
