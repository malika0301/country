...
const MovieCategoryAddModal = ({ category, movie, getMovieCategory }) => {
    ...
    const onFinish = async (values) => {
        try {
            await axios.post(`https://x8ki-letl-twmt.n7.xano.io/api:j6hO02gL/movie_category`,
                values,);
                    ...
                    <div style={{ display: "grid", gap: "10px" }}>
                        ...
                        <div style={{ display: "grid" }}>
                            <Form.Item
                                name="category_id"
                                layout='vertical'
                                label="Category" rules={[{ required: true }]}>
                                <Select
                                    allowClear
